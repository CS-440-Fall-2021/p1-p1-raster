...
//   let scl = 20;
//   let zoff = 0;
//   let rows = (zmax - zmin) / scl;
//   let cols = (xmax - xmin) / scl;
//   for (var z = zmin; z < rows; z++) {
//     let xoff = 0;
//     for (var x = xmin; x < cols; x++) {
//       ret.push(vec4(x * scl, getHeight(xoff, zoff), z * scl, 1));
//       ret.push(vec4(x * scl, getHeight(xoff, zoff), (z + 1) * scl, 1));
//       xoff += 0.1;
//     }
//     zoff += 0.1;
//   }
...
//   // points = get_patch2(0, canvas.width, 0, canvas.height);
//   points = get_patch(0, canvas.width, 0, canvas.height);
//   // points = TrianglesToWireframe(points);
